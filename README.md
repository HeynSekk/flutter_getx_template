...
I did some minor modification to [this useful template](https://github.com/hasancse91/flutter_getx_template). This repo can be useful in various cases like take-home assignments, doing practical developement in a playground project when learning some new concepts or technologies, or when developing small apps.
