...
import '../modules/fake_users/bindings/fake_users_binding.dart';
import '../modules/fake_users/views/fake_users_view.dart';
...
class AppPages {
  ...
  static final routes = [
    ...
    GetPage(
      name: _Paths.FAKE_USERS,
      page: () => FakeUsersView(),
      binding: FakeUsersBinding(),
    ),
  ];
}
