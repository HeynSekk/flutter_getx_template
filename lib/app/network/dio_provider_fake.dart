...
class DioProviderFake {
  static final String baseUrl = BuildConfig.instance.config.baseUrlFake;
  ...
  //named constructors
  DioProviderFake.setContentType(String version) {
    _instance?.options.contentType = _buildContentType(version);
  }

  DioProviderFake.setContentTypeApplicationJson() {
